...
/*
    ...
    Cmdline:
        sokol-shdc --input E:/gamedev/cheesecake/src/font.shader.glsl --output E:/gamedev/cheesecake/src/font.shader.glsl.h --slang glsl410:glsl300es:hlsl4:metal_macos:wgsl
